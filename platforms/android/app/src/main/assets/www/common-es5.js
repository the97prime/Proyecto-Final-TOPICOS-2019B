...
var AuthenticateService = /** @class */ (function () {
    ...
    AuthenticateService.prototype.loginUser = function (credentials) {
        var _this = this;
        var key = credentials.email;
        var encryptedPass = credentials.password;
        return new Promise(function (accept, reject) {
            _this.storage.get(key).then(function (usuario) {
                if (usuario) {
    ...
    AuthenticateService.prototype.registerUser = function (value) {
        var _this = this;
        return new Promise(function (accept, reject) {
            _this.storage.get(value.email).then(function (usuario) {
                if (usuario) {
                    console.log(usuario);
                    ...
                    _this.storage.set(value.email, value).then(function () {
